...
const WhatsAppButton = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -inset-1 rounded-full border border-primary/30 group-hover:border-primary/60 transition-colors" />
      
      {/* WhatsApp SVG Icon */}
      <svg 
        viewBox="0 0 24 24" 
        className="w-8 h-8 text-primary-foreground fill-current z-10"
